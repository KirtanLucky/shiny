...
library(shiny)
library("png")
filenames <- dir("C:\\Users\\Kirtan\\Documents\\shiny\\www\\","*.pdf")
value <- read.csv("C:\\Users\\Kirtan\\Documents\\shiny\\Process.csv",header=T,sep="\t")
print(value$label)
...
shinyServer(function(input,output){
        ...
        output$Results <-renderImage({
                val2 <- input$id1
                val1 <-"C:\\Users\\Kirtan\\Documents\\shiny\\www\\image\\"
                val3 <-".png"
                print(val2)
                if(input$id1 %in% value$label){
                        return(list(
                        ...
                        if(!(input$id1 %in% value$label)){
                                return(list(
                                        src ="C:\\Users\\Kirtan\\Documents\\shiny\\www\\image\\image.png",
                                        contentType = "image/png",
                                        alt = "Image"
                                ))
                        }}
        ...
        output$report = downloadHandler(
                filename = paste("C:\\Users\\Kirtan\\Documents\\shiny\\www\\",input$id1,".pdf",sep=""),
                content = function(file) {
                        if(input$id1 %in% value$label){
                                file.show(paste("C:\\Users\\Kirtan\\Documents\\shiny\\www\\",input$id1,".pdf",sep=""), file)}
                },
        ...
        output$help <- renderUI({
                val <- paste("C:\\Users\\Kirtan\\Documents\\shiny\\www\\image\\",input$id1,".pdf",sep="")
                print(val)
                HTML('<iframe
					seamless=NA,
					src=val>')
